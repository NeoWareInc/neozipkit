...
import { WalletSetupResult, NetworkConfig, NETWORKS, MintingOptions } from '../types';
import { Logger } from '../utils/Logger';
import { NZIP_CONTRACT_ABI } from './contracts';
...
// Standard ERC ABIs for balance/display (not NZIP contracts)
const ERC20_ABI = [
