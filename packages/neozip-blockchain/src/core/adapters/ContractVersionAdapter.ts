...
/**
 * Timestamp proof data (v2.50+)
 * Data structure for tokens minted with timestamp proof verification
 */
export interface TimestampProofData {
  hasTimestampProof: boolean;
  batchMerkleRoot: string;  // bytes32 as hex string
