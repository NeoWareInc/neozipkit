...
const jsReplacements = [
  ...
  [/require\("\.\.\/blockchain\/browser"\)/g, 'require("./blockchain/browser/index")'],
  [/require\("\.\.\/blockchain\//g, 'require("./blockchain/'],
...
const tsReplacements = [
  ...
  [/from ["']\.\.\/blockchain\/browser["']/g, 'from "./blockchain/browser/index"'],
  [/from ["']\.\.\/blockchain\//g, 'from "./blockchain/'],
